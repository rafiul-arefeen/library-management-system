...
public class AdminDashboardController {
    ...
    @FXML
    private Button btnHomepage, btnManageBooks, btnIssueBook, btnReturnBook, btnViewRecords, btnViewDefaulters, btnLogout;
    ...
    private void onSidebarOptionClick(ActionEvent event) {
        ...
        } else if (clickedButton == btnViewDefaulters) {
            fxmlFile = "ViewDefaulters.fxml";
